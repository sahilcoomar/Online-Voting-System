...
<body>
        ...
        <div id="page-wrapper">
			...
			<select name="position" id="position" class = "form-control pull-left" style = "width:300px;margin-left:19px; ">
				...
				<option></option>
								...
								<option>Head Professor</option>
								<option>Games In-charge</option>
								<option>Yoga In-charge</option>
								<option>Sports In-charge</option>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
			$query = $conn->query("SELECT * FROM candidate WHERE position = 'Principal'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
			require 'dbcon.php';
			$query = $conn->query("SELECT * FROM candidate WHERE position = 'Vice Principal'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'Head Of Department'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'Head Professor'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'Games In-charge'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'Yoga In-charge'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
	...
	?>
			...
			<table class="table table-striped table-bordered table-hover ">
					...
					<?php
		require 'dbcon.php';
		$query = $conn->query("SELECT * FROM candidate WHERE position = 'Sports In-charge'");
		while($fetch = $query->fetch_array())
		{
			$id = $fetch['candidate_id'];
			$query1 = $conn->query("SELECT COUNT(*) as total FROM `votes` WHERE candidate_id = '$id'");
