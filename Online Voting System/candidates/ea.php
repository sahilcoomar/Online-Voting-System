    ...
    <heading class="voters_heading">
        <center><h1>Registered Entertainment Advisor Candidates</h1>
           ...
           <select onchange = "page(this.value)">
                ...
                <option value = "pres.php">Principal</option>
                <option value = "vp.php">Vice Principal</option>
                <option value = "ua.php">Head Of Department</option>
                <option value = "ss.php">Head Professor</option>
                <option value = "ea.php">Games In-charge</option>
                <option value = "tr.php">Yoga In-charge</option>
                <option value = "vtr.php">Sports In-charge</option>
                <option value = "sg.php">Secretary Publicity</option>
