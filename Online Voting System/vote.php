...
<body>
	...
	<div class="col-lg-6">
	  <div class="panel panel-primary">
            <div class="panel-heading">
			<center>Sports In-charge</center>
            </div>
            <div class="panel-body" style = "background-color:;">
				<?php
	...
	<div class="col-lg-6">
     ...
     <hr/>
		...
		<center><button class = "btn btn-success ballot" type = "submit" name = "submit">Submit</button></center>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</form>
</body>
