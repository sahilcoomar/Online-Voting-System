    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			<div class="panel-heading"><center>Principal</center></div>
			<br />
			<?php
				if(!$_SESSION['pres_id'])
					{
			...
			<div class="panel-heading"><center>Vice Principal</center></div>
			<br />
			<?php
				if(!$_SESSION['vp_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>Head Of Department</center></div>
			<br/>
			<?php
				if(!$_SESSION['ua_id'])
					{
			...
			<div class = "alert alert-success" >
			<div class="panel-heading"><center>Head Professor</center></div>
			<br />
			<?php
				if(!$_SESSION['ss_id'])
					{
			...
			<div class="panel-heading"><center>Games In-charge</center></div>
			<br />
			<?php
				if(!$_SESSION['ea_id'])
					{
			...
			<div class = "alert alert-info" >
			<div class="panel-heading"><center>Yoga In-charge</center></div>
			<br />
			<?php
				if(!$_SESSION['sg_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>Sports In-charge</center></div>
			<br />
			<?php
				if(!$_SESSION['vtr_id'])
					{
